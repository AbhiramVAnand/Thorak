...
class FavAdapter(private val mList: List<AppListView>, val pm : PackageManager, val context : Context) : RecyclerView.Adapter<FavAdapter.ViewHolder>() {
